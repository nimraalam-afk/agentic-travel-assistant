# Utility functions and mocked APIs for the AgentsVille travel-planning project.
# Source: Udacity Agentic AI Nanodegree starter/project support code.
# Included here so the portfolio notebook can be reviewed and run locally.
